    ...
    build: function() {
      ...
      var parallaxEffectOnScrolResize = function() {
        ...
        $window.on('scroll resize', function() {
          ...
          var yPos    = -($window.scrollTop() - offset.top) / ((self.options.speed * 2 ) + (self.options.offset));
  ...
  PluginNeighborhoodMap.prototype = {
    ...
    build: function() {
      ...
      listOfLocations.each(function() {
        ...
        const category = locationDOM.closest('.accordion').find('.accordion-header').data('category');
      ...
      function showSelectedCategoryMarkers() {
        var categories = $('.accordion-header');
        ...
        categories.each(function() {
          ...
          category.on('click', function() {
            ...
            var categoryLocations = $('#' + id).find('.location');
            var leftMarkers = [];
            ...
            isSelectedCategory = $('.accordion-header.ui-accordion-header-active').length != 0;
...
(function($) {
  ...
  $(document).ready(function(){
    ...
    // Scrollbar
    if ($.isFunction($.fn.niceScroll) && !isMobile) {
      $('html').niceScroll();
