...
if ( ! function_exists( 'paisley_theme_scripts' ) ) {
	function paisley_theme_scripts() {
	    // Load bootstrap css
	    ...
	    // Load Paisley styles
	    wp_enqueue_style( 'paisley-style', get_stylesheet_uri() );
	    ...
	    // Load Nicescroll jQuery plugin
	    wp_enqueue_script( 'nicescroll', get_stylesheet_directory_uri() . '/assets/vendors/nicescroll/jquery.nicescroll.min.js', array('jquery') );    
	    ...
	    // Load theme script
	    wp_enqueue_script( 'theme', get_stylesheet_directory_uri() . '/assets/js/theme.min.js', array( 'nicescroll', 'isotope', 'magnific', 'lazyload' ) );
	...
	add_action( 'wp_enqueue_scripts', 'paisley_theme_scripts', 10, 2 );
}