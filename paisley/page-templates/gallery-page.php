...
get_header(); ?>
    ...
    <section class="section">
    	<div class="container" data-plugin-isotope>
			<div class="row">
				<div class="col">
					<ul class="gallery-categories">
						<li><a href="javascript:void(0);" class="gray-color fourth-bgcolor active" data-filter="*">All</a></li>
						<?php
                        $terms = get_terms( 'gallery_cat' );
                        foreach ( $terms as $term ):
                        ?>
						<li><a href="javascript:void(0);" class="gray-color fourth-bgcolor" data-filter=".<?php echo $term->slug; ?>"><?php echo $term->name; ?></a></li>
						<?php endforeach; ?>
					</ul>
				</div>
			</div>
            ...
            if ( $the_query->have_posts() ):
            	while ( $the_query->have_posts() ): $the_query->the_post();
                    ...
                    ?>
                	<div class="grid-item col-lg-4 col-md-6 col-12 <?php echo $class; ?>">
